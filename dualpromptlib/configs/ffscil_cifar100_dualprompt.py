...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--base_classes', default=60, type=int, help='number of rounds per task')
    subparsers.add_argument('--available_base_classes', default=36, type=int, help='number of available classes per task')
    subparsers.add_argument('--fs_classes', default=5, type=int, help='number of rounds per task')
    subparsers.add_argument('--available_fs_classes', default=3, type=int, help='number of available classes per task')

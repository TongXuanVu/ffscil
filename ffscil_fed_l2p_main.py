...
# from l2plib.fed_l2p_engine import *
from piplib.ffscil_fed_l2p_engine import *

import l2plib.models as models
...
def main(args):
    ...
    for task_id in range(0,args.num_tasks):
        ...
        for n_round in range(0,RT):
            ...
            train_pertask([models[i] for i in clients_index], 
...
if __name__ == '__main__':
    ...
    if config == 'cifar100_l2p':
        ...
        config_parser = subparser.add_parser('cifar100_dualprompt', help='Split-CIFAR100 L2P configs')
        # print()

    elif config == 'ffscil_l2p_cifar100_9tasks_60bases_5ways':
        print("Check ffscil_l2p_cifar100_9tasks_60bases_5ways")
        from configs.ffscil_l2p_cifar100_9tasks_60bases_5ways import get_args_parser
        config_parser = subparser.add_parser('ffscil_l2p_cifar100_9tasks_60bases_5ways', help='Split-CIFAR100 FFSCIL L2P configs')

    elif config == 'ffscil_l2p_imagenetsubset_9tasks_60bases_5ways':
        print("Check ffscil_l2p_imagenetsubset_9tasks_60bases_5ways")
        from configs.ffscil_l2p_imagenetsubset_9tasks_60bases_5ways import get_args_parser
        config_parser = subparser.add_parser('ffscil_l2p_imagenetsubset_9tasks_60bases_5ways', help='Split-ImagenetSubset FFSCIL L2P configs')

    elif config == 'ffscil_l2p_cub200_11tasks_100bases_10ways':
        print("Check ffscil_l2p_cub200_11tasks_100bases_10ways")
        from configs.ffscil_l2p_cub200_11tasks_100bases_10ways import get_args_parser
        config_parser = subparser.add_parser('ffscil_l2p_cub200_11tasks_100bases_10ways', help='Split-CUB200 FFSCIL L2P configs')

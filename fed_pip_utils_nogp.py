...
# def FedWeightedAvgPrototype(clients_prototype, clients_prototype_var, clients_weight, task_id, classes_per_task,args):
def FedWeightedAvgPrototype(clients_prototype, clients_prototype_var, clients_weight, task_id, args):
    ...
    if len(clients_prototype) == 0 or len(clients_prototype[0]) == 0:
        return {}, {}
    proto_size = list(clients_prototype[0].values())[0].shape[0]

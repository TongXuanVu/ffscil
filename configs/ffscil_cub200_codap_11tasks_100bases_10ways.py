...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--data-path', default='./dataset/', type=str, help='dataset path')
    ...
    subparsers.add_argument('--distributed', default=False, type=bool,)
    ...
    subparsers.add_argument('--freeze', default=['blocks', 'patch_embed', 'cls_token', 'norm', 'pos_embed', 'feat'], nargs='*', type=list, help='freeze part in backbone model')
    ...
    subparsers.add_argument('--lr_fs', type=float, default=0.01, metavar='LR_FS', help='learning rate for FS task(default: 0.03)')


    #For Federated CL setting
    subparsers.add_argument('--num_classes', default=200, type=int, help='number of total class')
    

    subparsers.add_argument('--num_tasks', default=11, type=int, help='number of tasks')
    subparsers.add_argument('--base_classes', default=100, type=int, help='number of classes in base task')
    subparsers.add_argument('--available_base_classes', default=60, type=int, help='number of available classes in base task')
    subparsers.add_argument('--fs_classes', default=10, type=int, help='number of classes in each FS task')
    subparsers.add_argument('--fs_shots', default=5, type=int, help='number of shots of each class in FS task')
    subparsers.add_argument('--available_fs_classes', default=6, type=int, help='number of available classes in each FS task')
    subparsers.add_argument('--fs_epochs', default=5, type=int, help='number of epochs in FS task')


    # subparsers.add_argument('--num_tasks', default=10, type=int, help='number of sequential tasks')
    subparsers.add_argument('--num_clients', default=20, type=int, help='number of all clients')
    subparsers.add_argument('--local_clients', default=6, type=int, help='number of selected clients per round')
    ...
    subparsers.add_argument('--batch_size', type=int, default=128, help="train batch_size")
    subparsers.add_argument('--workers', type=int, default=2, help="workers")
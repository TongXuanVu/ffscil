...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--lr_fs', type=float, default=0.1, metavar='LR_FS', help='learning rate for FS task(default: 0.03)')


    #For Federated CL setting
    subparsers.add_argument('--num_classes', default=100, type=int, help='number of total class')
    

    subparsers.add_argument('--num_tasks', default=9, type=int, help='number of tasks')
    subparsers.add_argument('--base_classes', default=60, type=int, help='number of classes in base task')
    subparsers.add_argument('--available_base_classes', default=36, type=int, help='number of available classes in base task')
    subparsers.add_argument('--fs_classes', default=5, type=int, help='number of classes in each FS task')
    subparsers.add_argument('--fs_shots', default=5, type=int, help='number of shots of each class in FS task')
    subparsers.add_argument('--available_fs_classes', default=3, type=int, help='number of available classes in each FS task')
    subparsers.add_argument('--fs_epochs', default=10, type=int, help='number of epochs in FS task')

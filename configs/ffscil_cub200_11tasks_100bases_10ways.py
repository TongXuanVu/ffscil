...
def get_args_parser(subparsers):
    ...
    subparsers.add_argument('--seed', default=2023, type=int)
    ...
    # subparsers.add_argument('--classes_per_task', default=60, type=int, help='number of rounds per task')
    # subparsers.add_argument('--available_classes', default=36, type=int, help='number of available classes per task')
